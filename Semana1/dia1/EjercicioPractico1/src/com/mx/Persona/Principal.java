	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				agregarPersonaUnica(listaP, auxPersona);
			...
			case 4:
				...
				do {
					...
					case 2:
						...
						break;
					case 3:
						System.out.println("Buscar apellido materno");
						scan = new Scanner(System.in);
						apellidoMaterno = scan.nextLine();
			...
			case 5:
				...
				do {
					...
					case 3:
						System.out.println("Eliminar por apellido materno");
						scan = new Scanner(System.in);
						apellidoMaterno = scan.nextLine();
						...
						break;
					case 4:
						System.out.println("Eliminar por edad");
						scan = new Scanner(System.in);
						edad = scan.nextInt();
...
//		}
	...
	// Método para eliminar personas por nombre
	    ...
	    public static void agregarPersonaUnica(List<Persona> lista, Persona nuevaPersona) {
	        boolean existe = lista.stream().anyMatch(persona ->
	                persona.getNombre().equalsIgnoreCase(nuevaPersona.getNombre()) &&
	                persona.getApellidoPaterno().equalsIgnoreCase(nuevaPersona.getApellidoPaterno()) &&
	                persona.getApellidoMaterno().equalsIgnoreCase(nuevaPersona.getApellidoMaterno()) &&
	                persona.getEdad() == nuevaPersona.getEdad() &&
	                persona.getEmail().equalsIgnoreCase(nuevaPersona.getEmail())
	        );

	        if (!existe) {
	            lista.add(nuevaPersona);
	            System.out.println("Persona agregada: " + nuevaPersona.getNombre() + " " + nuevaPersona.getApellidoPaterno());
	        } else {
	            System.out.println("La persona ya existe en la lista: " + nuevaPersona.getNombre() + " " + nuevaPersona.getApellidoPaterno());
	        }
	    }
