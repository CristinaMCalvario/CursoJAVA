			...
			try {
					...
					System.out.println("---------->BUSCAR");
							...
							do {
								...
								case 2:
									...
									System.out.println("FIguras con los lados '" + lados + "':");
								...
								case 3:
									...
									System.out.println("FIguras con vertices '" + vertices + "':");
								...
								case 4:
									...
									System.out.println("FIguras con area '" + area + "':");
								...
								case 5:
									...
									System.out.println("FIguras con el perimetro '" + perimetro + "':");
						...
						if (indice >= 0 && indice < imp.listaF.size()) {
							do {
								...
								case 1:
									...
									String nuevoNombre = datos.nextLine();

									boolean existe = false;
									for (Figura f : imp.listaF) {
									    if (f.getNombreF().equalsIgnoreCase(nuevoNombre)) {
									        existe = true;
									        break;
									    }
									}
									...
									if (existe) {
									    System.out.println("Ese nombre ya existe. Intenta con otro.");
									} else {
									    figura.setNombreF(nuevoNombre);
								...
								case 2:
									...
									if (existel) {
									    System.out.println("Ese lado ya existe. Intenta con otro.");
									} else {
										figura.setLados(lados);
									    System.out.println("Lado actualizado correctamente.");
									}
				...
				case 4:
					...
					do {
						...
						System.out.println("2.- ELIMINAR LADOS");
						System.out.println("3.- ELIMINAR VERTICES");
						System.out.println("4.- ELIMINAR AREA");
						System.out.println("5.- ELIMINAR PERIMETRO");
						System.out.println("6.- SALIR");
						System.out.println("--------ELIGE UNA OPCION VALIDA EN EL MENU-----");
						muenuD = datos.nextInt();
						datos.nextLine();
						...
						case 1:
							...
							System.out.println("Ingresa nuevo nombre: ");
							nombre = datos.nextLine();
							imp.eliminarNombre(imp.listaF, nombre);
					        System.out.println("Lista después de eliminar nombre '" + nombre + "':");
					        imp.listaF.forEach(System.out::println);
							
							
							break;
						case 2:
							System.out.println("------> ELIMINAR LADOS");
							System.out.println("Ingresa nuevos lados: ");
							lados = datos.nextInt();
							datos.nextLine();
							imp.eliminarArea(imp.listaF, lados);
					        System.out.println("Lista después de eliminar area '" + lados + "':");
					        imp.listaF.forEach(System.out::println);
					        break;
						case 3:
							System.out.println("------> ELIMINAR VERTICES");
							System.out.println("Ingresa nuevos lados: ");
							vertices = datos.nextInt();
							datos.nextLine();
							imp.eliminarArea(imp.listaF, vertices);
					        System.out.println("Lista después de eliminar area '" + vertices + "':");
					        imp.listaF.forEach(System.out::println);
					        break;
						case 4:
							...
							area = datos.nextInt();
							datos.nextLine();
							imp.eliminarArea(imp.listaF, area);
					        System.out.println("Lista después de eliminar area '" + area + "':");
					        imp.listaF.forEach(System.out::println);
					        break;
					        
						case 5:
							System.out.println("------> ELIMINAR PERIMETRO");
							System.out.println("Ingresa nuevos lados: ");
							perimetro = datos.nextInt();
							datos.nextLine();
							imp.eliminarArea(imp.listaF, perimetro);
					        System.out.println("Lista después de eliminar area '" + perimetro + "':");
					        imp.listaF.forEach(System.out::println);
					        break;   
						case 6: 
				...
				System.out.println("Entrada invalida. por favor ingresa un numeroo");
				datos.nextLine();
			}
			catch (Exception e) {
...
//		imp.contar();
	...
	public static void buscarExistencia(Implementacion imp, Figura nuevaFigura) {
