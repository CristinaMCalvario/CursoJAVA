/*
ejercicio con trigger multiple
*/
--DESACTIVAR EL TRIGGER SIMPLE
--DIRECTAMENTE DESDE CONEXIONES 
--DESDE SENTENCIA
...
DECLARE
    ...
    LV_FECHA DATE;
BEGIN
    --RECUPERAR EL ID VALIDA PARA BITACRA USANDO UNA SECUENCIA
    SELECT S_ID_BIT_COMPU.NEXTVAL,USER, SYSDATE INTO LV_ID_BIT,LV_USUARIO,LV_FECHA FROM DUAL;
    
    --SENTENCIAS PARA EL REGISTRO DE LA TABLA BIT_COMPUTADORA
    IF INSERTING THEN
    ...
    ELSIF UPDATING THEN
        INSERT INTO BIT_COMPUTADORA(ID_BIT,ID_COMPU,MARCA, MODELO,RAM,PROCESADOR,PRECIO,MARCA_OLD,
        MODELO_OLD,RAM_OLD,PROCESADOR_OLD,PRECIO_OLD,USUARIO,FECHA_MOV,MOVIMIENTO)
        VALUES(LV_ID_BIT,:OLD.ID_COMPU,:NEW.MARCA,:NEW.MODELO,:NEW.RAM,:NEW.PROCESADOR,:NEW.PRECIO,
...
--EJERCICIO CREAR UNA NUEVA ENTIDAD CON SU BITACORA Y CREAR EL TRIGER MULTIPLE CON SU SECUENCIA
--INSERTAR MAX 5 REGISTROS PARA VISUALIZAR BIEN LAS PRUEBAS
